...
module.exports = [
  ...
  {
    // Волна 5.1/5.2/5.3: эти скрипты require()'ят lib/agis-core.js внутри Node-only ветки
    ...
    // скриптов, это должно остаться ошибкой ESLint (no-undef), а не молча пройти.
    files: [
