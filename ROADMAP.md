...
1. `release.yml` и проверка бампа `@version` на PR — отложены, брать по мере необходимости.
2. TypeScript через `.user.ts` (см. Волна 5) — самая крупная и наименее приоритетная задача.
